#include "gestion_billets.h"
#include "ui_gestion_billets.h"
#include <QMessageBox>
#include "billet.h"
...
gestion_billets::gestion_billets(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::gestion_billets)
{
    ui->setupUi(this);
...
gestion_billets::~gestion_billets()
{
    delete ui;
}
void gestion_billets::on_button_ajouter_clicked()
{
...
void gestion_billets::on_pbSupprimer_clicked()
{
...
void gestion_billets::on_updateBP_clicked()
{
...
void gestion_billets::on_pushButton_clicked()
{
    QString strStream;
...
void gestion_billets::on_recher_clicked()
{Billet B ;
...
void   gestion_billets::mailSent(QString status)
{
...
void gestion_billets::on_pb_code_clicked()
{ Billet C ;
...
void gestion_billets::on_pb_excel_clicked()
{
...
void gestion_billets::update_label()
{
    ...
    data=A1.read_from_arduino();
           ...
           if(test==1)
       {
               ...
               ui->label_arduino->setText("OUVERT"); // si les données reçues de arduino via la liaison série sont égales à 1
       ...
       A1.write_to_arduino("1");
              ...
              // N.notification_fermeture();
               ui->label_arduino->setText("FERMER");
