...
void Avions::on_pbajouter_clicked()
...
void Avions::on_pbajouter_2_clicked()
{
...
void Avions::on_pbajouter_3_clicked()  //afficher
{
    QString id=ui->id_3->text() ;
    QString nom=ui->nom_2->text() ;
    QString salaire=ui->salaire_2->text() ;
...
void Avions::on_pbajouter_10_clicked() //trier
{
...
void Avions::on_pbajouter_12_clicked()
{
...
void Avions::on_LE_Chercher_textChanged(const QString &arg1)
{
...
void Avions::on_pushButton_Supp_clicked()
{
...
void Avions::on_retourner_clicked()
{
    hide();
}
