...
mainwindowayoub::mainwindowayoub(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::mainwindowayoub)
{
    ui->setupUi(this);
...
mainwindowayoub::~mainwindowayoub()
{
    delete ui;
}
void mainwindowayoub::on_button_ajouter_clicked()
{
...
void mainwindowayoub::on_pbSupprimer_clicked()
{
...
void mainwindowayoub::on_updateBP_clicked()
{
...
void mainwindowayoub::on_pushButton_clicked()
{
    QString strStream;
...
void mainwindowayoub::on_recher_clicked()
{Billet B ;
...
void  mainwindowayoub::mailSent(QString status)
{
...
void mainwindowayoub::on_pb_code_clicked()
{ Billet C ;
...
void mainwindowayoub::on_pb_excel_clicked()
{
...
void mainwindowayoub::update_label1()
{
    ...
    data=A1.read_from_arduino();
           ...
           if(test==1)
       {
               ...
               ui->labell->setText("OUVERT"); // si les données reçues de arduino via la liaison série sont égales à 1
...
void mainwindowayoub::on_retourner_clicked()
{
    hide();
}
